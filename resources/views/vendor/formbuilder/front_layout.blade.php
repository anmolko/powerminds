@extends(config('formbuilder.frontend_layout_file', 'frontend.layouts.master'))
...
@prepend(config('formbuilder.layout_js_stack', 'scripts'))
	...
	<script src="{{ asset('vendor/formbuilder/js/script.js') }}{{ doode\FormBuilder\Helper::bustCache() }}" defer></script>
@endprepend
