...
@section('title') Show Form @endsection
                        ...
                        <h5 class="card-title">
                            ...
                            <div class="btn-toolbar float-md-end" role="toolbar">
                                <div class="btn-group" role="group">
                                    ...
                                    <a href="{{ route('formbuilder::forms.submissions.index', $form) }}" class="btn btn-primary float-md-end btn-sm">
                                        <i class="fa fa-th-list"></i> Submissions
                                    </a> 
                                    <a href="{{ route('formbuilder::forms.edit', $form) }}" class="btn btn-primary float-md-end btn-sm">
                                        <i class="fa fa-edit"></i> Edit
                                    </a> 
                                    <a href="{{ route('formbuilder::forms.create') }}" class="btn btn-primary float-md-end btn-sm">
