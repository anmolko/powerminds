                        ...
                        <h5 class="card-title">
                            ...
                            <div class="btn-toolbar float-md-end" role="toolbar">
                                <div class="btn-group" role="group">
                                    <a href="{{ route('formbuilder::forms.index') }}" class="btn btn-sm btn-primary float-md-end">
                    ...
                    <form action="{{ route('formbuilder::forms.update', $form) }}" method="POST" id="createFormForm" data-form-method="PUT">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label for="custom_description" class="col-form-label">Successful Message Box </label>

                                        <textarea id="custom_description"  rows="4" cols="20" class="form-control{{ $errors->has('custom_description') ? ' is-invalid' : '' }}" name="custom_description" required autofocus >
                                        {{ old('custom_description') ?? $form->custom_description }}
                                        </textarea>

                                        @if ($errors->has('custom_description'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('custom_description') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
