            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="service-title-input" name="title" value="{{@$edit->title}}"  onclick="slugMaker('service-title-input','service-slug-input')"
                                       placeholder="Enter service title" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="service-slug-input">Slug</label>
                                <input type="text" class="form-control" id="service-slug-input" value="{{@$edit->slug}}" name="slug"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <textarea class="form-control" maxlength="350" id="sub-title-status-input" placeholder="Enter sub description" name="sub_description" rows="4">{!! @$edit->sub_description !!}</textarea>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                <img  id="current-img"  src="{{ ($edit->banner_image !== null) ? asset('images/service/'.$edit->banner_image) :  asset('images/default-image.jpg') }}" class="position-relative img-fluid img-thumbnail blog-feature-image" >
