                    ...
                    <div class="tab-content text-muted">
                        ...
                        @if($settings !== null)
                            ...
                            <div class="tab-pane fade" id="status-overview" role="tabpanel">
                                ...
                                {!! Form::open(['url'=>route('settings.grievance', @$settings->id),'id'=>'status-terms-form','class'=>'needs-validation','novalidate'=>'','method'=>'PUT']) !!}
                                <div class="row  mb-4">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="position-relative mb-3">
                                                    ...
                                                    <textarea class="form-control" id="ckeditor-classic" name="grievance_description" placeholder="Enter grievance description" rows="6" required>{{@$settings->grievance_description}}</textarea>
                                                    <div class="invalid-tooltip">
                                                        Please enter the website summary.
                                                    </div>
                                                </div>
