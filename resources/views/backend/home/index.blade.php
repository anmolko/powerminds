                            ...
                            <div class="card-body pb-0 px-4">
                                ...
                                <ul class="nav nav-tabs-custom border-bottom-0" role="tablist">
                                    ...
                                    @if($homesettings !== null)
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link fw-semibold" data-bs-toggle="tab" href="#what-wedo"
                                               role="tab">
                                                What we do best
                                            </a>
                                        </li>
                ...
                <div class="col-lg-12">
                    <div class="tab-content text-muted">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        ...
                                                        <textarea class="form-control" maxlength="540" name="welcome_description" id="welcome_description" placeholder="Enter welcome description" rows="8" required>{{@$homesettings->welcome_description}}</textarea>
                        ...
                        @if($homesettings !== null)
                            ...
                            <div class="tab-pane fade" id="what-wedo" role="tabpanel">

                                {!! Form::open(['url'=>route('homepage.whatwedo', @$homesettings->id),'id'=>'homesettings-simple-header-form','class'=>'needs-validation','novalidate'=>'','method'=>'PUT','enctype'=>'multipart/form-data']) !!}
                                ...
                                <div class="row  mb-4">
                                    <div class="col-lg-12">
                                        <div class="sticky-side-div">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5 class="card-title mb-0">What we do Details</h5>
                                                </div>
                                                <div class="card-body">
                                                    <figure class="figure">
                                                        <img src="{{asset('images/whatwedo.png')}}" class="figure-img img-fluid rounded" alt="...">
                                                        <figcaption class="figure-caption">Output Sample.</figcaption>
                                                    </figure>
                                                    <div class="position-relative mb-3">
                                                        <label class="form-label" for="ww_main_heading">Main Heading <span class="text-muted text-danger">*</span></label>
                                                        <input type="text" class="form-control" maxlength="60" id="ww_main_heading" name="ww_main_heading" value="{{@$homesettings->ww_main_heading}}"
                                                               placeholder="Enter heading" required>
                                                        <div class="invalid-feedback">
                                                            Please enter the heading.
                                                        </div>
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        <label class="form-label" for="ww_main_subheading">Main Sub Heading <span class="text-muted text-danger">*</span></label>
                                                        <input type="text" class="form-control" maxlength="40" id="ww_main_subheading" name="ww_main_subheading" value="{{@$homesettings->ww_main_subheading}}"
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        <label> Main Description <span class="text-muted text-danger">*</span></label>
                                                        <textarea class="form-control" maxlength="440" name="ww_main_description" id="ww_main_description" placeholder="Enter description" rows="4" required>{{@$homesettings->ww_main_description}}</textarea>
                                                        <div class="invalid-tooltip">
                                                            Please enter the  description.
                                                        </div>
                                                    </div>
                                ...
                                <div class="row  mb-2">
                                    <div class="col-lg-6">
                                        <div class="nosticky-side-div">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5 class="card-title mb-0">First Section</h5>
                                                </div>
                                                <div class="card-body">
                                                    <div class="position-relative mb-3">
                                                        <label class="form-label">Heading 1 <span class="text-muted text-danger">*</span></label>
                                                        <input type="text" class="form-control" maxlength="30" name="ww_heading1" value="{{@$homesettings->ww_heading1}}"
                                                               placeholder="Enter heading " required>
                                                        <div class="invalid-feedback">
                                                            Please enter the heading.
                                                        </div>
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        <label class="form-label"> Description 1 <span class="text-muted text-danger">*</span></label>
                                                        <textarea class="form-control" maxlength="600" name="ww_description1" placeholder="Enter description" rows="4" required>{{@$homesettings->ww_description1}}</textarea>
                                                        <div class="invalid-tooltip">
                                                            Please enter the description.
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="position-relative mb-3">
                                                        ...
                                                        <input type="text" class="form-control" maxlength="30" name="ww_heading2" value="{{@$homesettings->ww_heading2}}"
                                                               placeholder="Enter heading " required>
                                                        <div class="invalid-feedback">
                                                            Please enter the heading.
                                                        </div>
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        ...
                                                        <textarea class="form-control" maxlength="600" name="ww_description2" placeholder="Enter description" rows="4" required>{{@$homesettings->ww_description2}}</textarea>
                                                        <div class="invalid-tooltip">
                                                            Please enter the description.
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="position-relative mb-3">
                                                        ...
                                                        <input type="text" class="form-control" maxlength="30" name="ww_heading3" value="{{@$homesettings->ww_heading3}}"
                                                               placeholder="Enter heading " required>
                                                        <div class="invalid-feedback">
                                                            Please enter the heading.
                                                        </div>
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        ...
                                                        <textarea class="form-control" maxlength="600" name="ww_description3" placeholder="Enter description" rows="4" required>{{@$homesettings->ww_description3}}</textarea>
                                                        <div class="invalid-tooltip">
                                                            Please enter the description.
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="nosticky-side-div">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5 class="card-title mb-0">Fourth Section</h5>
                                                </div>
                                                <div class="card-body">
                                                    <div class="position-relative mb-3">
                                                        <label class="form-label">Heading 4 <span class="text-muted text-danger">*</span></label>
                                                        <input type="text" class="form-control" maxlength="30" name="ww_heading4" value="{{@$homesettings->ww_heading4}}"
                                                               placeholder="Enter heading " required>
                                                        <div class="invalid-feedback">
                                                            Please enter the heading.
                                                        </div>
                                                    ...
                                                    <div class="position-relative mb-3">
                                                        <label class="form-label"> Description 4 <span class="text-muted text-danger">*</span></label>
                                                        <textarea class="form-control" maxlength="600" name="ww_description4" placeholder="Enter description" rows="4" required>{{@$homesettings->ww_description4}}</textarea>
                                                        <div class="invalid-tooltip">
                                                            Please enter the description.
                                                        </div>
                                                    </div>
...
{{--                                            <div class="card">--}}
{{--                                                <div class="card-header">--}}
{{--                                                    <h5 class="card-title mb-0"> Core 7 Details</h5>--}}
{{--                                                </div>--}}
{{--                                                <div class="card-body">--}}
{{--                                                    <div class="position-relative mb-3">--}}
{{--                                                        <label class="form-label">Core Heading 7 <span class="text-muted text-danger">*</span></label>--}}
{{--                                                        <input type="text" class="form-control" maxlength="30" name="core_heading7" value="{{@$homesettings->core_heading7}}"--}}
{{--                                                               placeholder="Enter heading" required>--}}
{{--                                                        <div class="invalid-feedback">--}}
{{--                                                            Please enter the heading.--}}
{{--                                                        </div>--}}
...
{{--                                            <div class="card">--}}
{{--                                                <div class="card-header">--}}
{{--                                                    <h5 class="card-title mb-0"> Core 8 Details</h5>--}}
{{--                                                </div>--}}
{{--                                                <div class="card-body">--}}
{{--                                                    <div class="position-relative mb-3">--}}
{{--                                                        <label class="form-label">Core Heading 8 <span class="text-muted text-danger">*</span></label>--}}
{{--                                                        <input type="text" class="form-control" maxlength="30" name="core_heading8" value="{{@$homesettings->core_heading8}}"--}}
{{--                                                               placeholder="Enter heading" required>--}}
{{--                                                        <div class="invalid-feedback">--}}
{{--                                                            Please enter the heading.--}}
{{--                                                        </div>--}}
...
{{--                                                        <textarea class="form-control" maxlength="300" name="mission" placeholder="Enter mission description" rows="4" required>{{@$homesettings->mission}}</textarea>--}}
{{--                                                        <div class="invalid-tooltip">--}}
{{--                                                            Please enter the  description.--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
...
{{--                                                        <textarea class="form-control" maxlength="300" name="vision" placeholder="Enter vision description" rows="4" required>{{@$homesettings->vision}}</textarea>--}}
{{--                                                        <div class="invalid-tooltip">--}}
{{--                                                            Please enter the  description.--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
...
{{--                                                        <textarea class="form-control" maxlength="300" name="value" placeholder="Enter value description" rows="4" required>{{@$homesettings->value}}</textarea>--}}
{{--                                                        <div class="invalid-tooltip">--}}
{{--                                                            Please enter the  description.--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
...
{{--                                                <div class="form-group mb-3">--}}
{{--                                                    <label>Description <span class="text-muted text-danger">*</span></label>--}}
{{--                                                    <textarea class="form-control" rows="6" maxlength="1750" name="description[]" required>{{@$recruitment[0]->description}}</textarea>--}}
{{--                                                    <div class="invalid-feedback">--}}
{{--                                                        Please enter the description.--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
