            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-xl-12 d-flex flex-row align-items-center">
                        ...
                        <div class="top_bar_contact_item d-flex align-items-center" style="padding-left: 0px; border-right:none!important;">
                            ...
                            <div class="site-navigation d-flex flex-row align-items-center justify-content-between">
                                ...
                                <div class="site-branding ">
                                    <a class="home-link" href="/" title="Axacus" rel="home">
                                        <img id="logo-img" height="45" width="175" class="img-fluid auto_size" src="<?php if(@$setting_data->logo){?>{{asset('/images/settings/'.@$setting_data->logo)}}<?php }else{?>{{asset('assets/frontend/images/logo-img.svg')}}<?php } ?>" alt="@if(!empty(@$setting_data->website_name)) {{ucwords(@$setting_data->website_name)}} @else Power Minds Pvt. Ltd. @endif" style="max-height: 80px;" title="@if(!empty(@$setting_data->website_name)) {{ucwords(@$setting_data->website_name)}} @else Power Minds Pvt. Ltd. @endif">
                                    </a>
